  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-[1fr_auto_1fr] gap-6 md:gap-5 items-stretch">
      ...
      <div className="flex md:flex-col items-center justify-center gap-2 text-accent py-2 md:py-0">
        ...
        <span className="text-[10px] font-mono uppercase tracking-widest text-gray-500">becomes</span>
      </div>
        ...
        {!revealed ? (
          ...
          <div className="flex flex-col flex-1">
            <div className="bg-white/5 border border-white/10 rounded-xl p-3 mb-3">
              <div className="text-[10px] font-mono uppercase tracking-widest text-gray-500 mb-1">You wrote</div>
