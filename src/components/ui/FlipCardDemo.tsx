  ...
  return (
    <div className="w-full max-w-[320px]" style={{ perspective: '1200px' }}>
      ...
      >
        ...
        >
          <span className="font-mono text-[11px] uppercase tracking-widest text-gray-400">{kind}</span>
        ...
        >
          <span className="font-mono text-[11px] uppercase tracking-widest text-accent">Answer</span>
          {options ? (
